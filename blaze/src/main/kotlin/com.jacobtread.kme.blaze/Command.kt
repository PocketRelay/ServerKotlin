...
enum class Command(val component: Component, val value: Int) {
    ...
    GAME_MANAGER_1E(GAME_MANAGER, 0x1E),
    ...
    GAME_REPORT_RESULT_72(GAME_REPORTING, 0x72),

    // User Sessions Component
    SET_SESSION(USER_SESSIONS, 0x1),
